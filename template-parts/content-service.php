    ...
    <div class="row justify-content-center">
      <div class="col-lg-8 col-sm-12 m-auto">
        <div class="heading text-white text-center">
          <h4 class="section-title text-white"><?php if (!empty($args['custom_title'])) {
          ...
          <p>
            <?php
              if (!empty($args['custom_subtitle'])) {
                echo $args['custom_subtitle'];
              } else {
                echo 'Подзаголовок ещё не добавлен, извините(';
              }
            ?>
          </p>
        </div>
